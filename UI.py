...
class EnigmaGameUI:
    ...
    def update_timer_label(self): ##generated by chatgpt, added in by Joseph
    ...
    def show_hint(self):
        ...
        self.after_hint_action()  # Trigger the next action after closing the message box #joseph's edit
    
    def after_hint_action(self): #generated by CHATGPT, added by Joseph
        print("Hint box clicked and closed!")
        self.hint_label.config(text="The hint box was acknowledged.")
        
        # Reduce the timer by 10 seconds
        self.timer_seconds = max(0, self.timer_seconds - 10)
        self.update_timer_label()  # Update the displayed timer
